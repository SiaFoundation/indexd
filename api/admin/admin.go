...
func NewAPI(chain ChainManager, contracts ContractManager, hosts HostManager, pm PinManager, syncer Syncer, wallet Wallet, store Store, opts ...Option) http.Handler {
	a := &admin{
		chain:     chain,
		contracts: contracts,
		hosts:     hosts,
