...
func (m *mockHostClient) ReadSector(ctx context.Context, token proto.AccountToken, root types.Hash256, w io.Writer, offset, length uint64) (rhp.RPCReadSectorResult, error) {
